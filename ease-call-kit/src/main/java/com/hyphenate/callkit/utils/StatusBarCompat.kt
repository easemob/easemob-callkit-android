 ...
 *
 * \~english
 * Status bar compatibility tool class
 */
object StatusBarCompat {
     ...
     *
     * \~english
     * Set MIUI status bar light mode
     */
     ...
     *
     * \~english
     * Set Flyme status bar light mode
     */
    ...
    fun setToolbarCustomColorDefault(
        ...
        if (leftArrow == null) {
            leftArrow = ContextCompat.getDrawable(context, R.drawable.callkit_default_navigation_icon)
        }
        if (leftArrow != null) {
